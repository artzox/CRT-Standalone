...
---
Installation
Copy `CRT-Standalone.fx` into your game's ReShade `Shaders` folder
Enable the technique in the ReShade overlay
The shader compiles with default settings — most features are on by default
---
